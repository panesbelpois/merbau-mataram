...
const VillageDescription = () => {
    return (
        <section className="bg-white py-16 px-4 sm:px-6 lg:px-8 w-full border-b border-gray-100 font-poppins">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-3xl font-bold text-gray-800 mb-8 border-l-4 border-sky-600 pl-4">Tentang Desa</h2>
